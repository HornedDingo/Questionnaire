<div id="add-form" id="addModal" class="modal popup-bg" style="display: none;"> 
  <div class="popup"  style="background: antiquewhite;"> 
    ...
    <form id="add-entry-form" method="post" action="/src/functions/add_entry_application.php" style="margin-left: 10%; margin-right: 10%;"> 
      ...
      <div class="form-floating mb-3">
        ...
        <div class="form-floating mb-3">
            <input type="text"  id="vehicles_brand" name="vehicles_brand" value="" class="form-control rounded-3" placeholder="Марка транспортного средства">
            <label for="vehicles_brand">Марка транспортного средства</label>
        </div>
        <div class="form-floating mb-3">
            <input type="text"  id="vehicles_number" name="vehicles_number" value="" class="form-control rounded-3" placeholder="Номер транспортного средства">
            <label for="vehicles_number">Номер транспортного средства</label>
        </div>
        <div class="form-floating mb-3">
            <input type="text"  id="color" name="color" value="" class="form-control rounded-3" placeholder="Цвет">
