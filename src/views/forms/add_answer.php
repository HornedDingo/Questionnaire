<div id="add-form" id="addModal" class="modal popup-bg" style="display: none;"> 
  <div class="popup"> 
    ...
    <form id="add-answer-form" method="post" action="/src/functions/add_answer.php"> 
      ...
      <button name="add_answer" type="submit" class="w-50 mb-4 btn btn-lg rounded-3 btn-primary" style="width: 2%; margin-bottom: 2%; margin-top: 4%; margin-left: 25%">Добавить</button> 
    </form> 
  </div> 
</div>