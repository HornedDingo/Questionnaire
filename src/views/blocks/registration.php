<div id="myModal2" style="display:none;" class="popup-bg">
    <div id="myModalContent2" class="popup">
        <div class="modal-header p-5 pb-4 border-bottom-0">
            <h1 class="fw-bold mb-0 fs-2" style="margin: auto;">Регистрация</h1>
        ...
        <div class="modal-body p-5 pt-0">
            ...
            <small class="text-body-secondary">Нажимая кнопку "Зарегистрироваться", вы соглашаетесь с условиями пользования</small>
            </form>
        </div>
    </div>
</div>
